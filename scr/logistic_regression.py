...
#
# The model is intended to predict outcomes after the
# first semester, so second-semester information is excluded.
# ---------------------------------------------------------
...
# Train/test split
#
# The test set is created but will NOT be used for model
# selection or evaluation at this stage.
# ---------------------------------------------------------
...
#
# Binary variables:
# Passed through unchanged as 0/1.
# ---------------------------------------------------------
...
# Evaluation metrics
#
# Macro averaging gives each of the three classes equal
# importance, which is useful because the target is imbalanced.
# ---------------------------------------------------------
